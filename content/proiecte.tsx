...
`,
    cheltuieliEligibile: `Activități aferente activității de bază
...
•	Alte abilități și a competențe pentru specializare inteligentă, pentru tranziție industrială și antreprenoriat în afara celor descrise mai sus, care sunt în legatură cu domeniul vizat de proiect.
•	Investiții în procese de producție ecologice și de utilizare eficientă a resurselor în Microîntreprinderi achiziționarea de instalații/ echipamente specifice în scopul obținerii unei economii de energie, precum și sisteme care utilizează surse regenerabile (alternative) de energie pentru eficientizarea activităților pentru care a solicitat finanțare. Surse regenerabile (alternative) de energie: energia solară (utilizată la producerea de căldură sau la furnizarea de energie electrică prin sisteme fotovoltaice); energia eoliană; hidroenergia; energia geotermală.
•	Cheltuieli pentru amenajarea terenului
•	Amenajarea terenului
•	Amenajări pentru protecția mediului și aducerea la starea inițialeCheltuieli pentru relocarea/protecția utilităților (devieri rețele de utilități din amplasament)
•	Cheltuielile pentru asigurarea utilităților necesare obiectivului
•	Cheltuieli pentru proiectare și asistență tehnică – Studii (geotehnice, geologice, hidrologice, etc.)
...
•	întocmirea documentației cadastrale, obținerea numărului cadastral provizoriu și
...
•	Cheltuieli de informare și publicitate - Plafon de cheltuială maximă - 7500 Ron (fără TVA).
•	Cheltuielile cu activitatea de audit financiar extern - eligibile în limita a 5000 Ron/trimestru (fără TVA),
