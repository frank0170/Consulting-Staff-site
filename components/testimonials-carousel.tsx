      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 pt-5 md:pt-7 md:pb-16">
            <h2 className="h2 mb-4">Proiecte integrate si implementate cu success</h2>
            <p className="text-xl text-gray-600" data-aos="zoom-y-out">Povestile afacerilor pentru care am dezvoltat proiecte si au avut success</p>
          </div>
