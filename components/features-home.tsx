...
import TopImage from '@/public/images/feature-consult-1.png'
      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
        <div className="pt-12 md:pt-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16">
            <h1 className="h2 mb-4">Parcursul unui Proiect</h1>
            <p className="text-xl text-gray-600">În general, procesul de planificare constă într-o serie de etape bine definite, care asigură că proiectul va fi realizat cu succes.</p>
          </div>
          ...
          <div className="md:grid md:grid-cols-12 md:gap-6">
            ...
            <div className="max-w-xl md:max-w-none md:w-full mx-auto md:col-span-7 lg:col-span-6 md:mt-6" data-aos="fade-right">
              <div className="md:pr-4 lg:pr-12 xl:pr-16 mb-8">
                <h3 className="h3 mb-3">Avantajele unei finantari</h3>
                <p className="text-xl text-gray-600">Finanțarea de tip startup oferă un set de avantaje semnificative pentru o afacere în faza incipientă. </p>
              </div>
              {/* Tabs buttons */}
              <div className="mb-8 md:mb-0">
                ...
                >
                  <div>
                    <div className="font-bold leading-snug tracking-tight mb-1">Validare și credibilitate</div>
                    <div className="text-gray-600">Obținerea finanțării de tip startup poate aduce o validare externă a afacerii și a potențialului său de creștere. Partenerii care aleg să finanțeze un startup înseamnă că au încredere în ideea de afacerii. </div>
                ...
                >
                  <div>
                    <div className="font-bold leading-snug tracking-tight mb-1">Oportunitatea de a crește rapid</div>
                    <div className="text-gray-600">Finanțarea suplimentară poate genera o creștere rapidă a afacerii, aducând beneficii semnificative în ceea ce privește veniturile și cota de piață.</div>
                  </div>
                  <div className="flex justify-center items-center w-8 h-8 bg-white rounded-full shadow shrink-0 ml-3">
                    <svg className="w-3 h-3 fill-current" viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg">
                ...
                >
                  <div>
                    <div className="font-bold leading-snug tracking-tight mb-1">Flexibilitate în utilizarea fondurilor</div>
                    <div className="text-gray-600">Finanțarea de stil startup oferă o mai mare flexibilitate în utilizarea fondurilor. Aceasta permite afacerii să-și aloce resursele acolo unde sunt cele mai necesare la momentul dat.</div>
                  </div>
                  <div className="flex justify-center items-center w-8 h-8 bg-white rounded-full shadow shrink-0 ml-3">
                    <svg className="w-3 h-3 fill-current" viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg">
            ...
            {/* Tabs items */}
            <div className="max-w-xl md:max-w-none md:w-full mt-40 mx-auto md:col-span-5 lg:col-span-6 mb-8 md:mb-0 md:order-1">
