  ...
  return (
    <footer>
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        {/* Top area: Blocks */}
        <div className="grid sm:grid-cols-12 gap-0 py-0 sm:gap-8 sm:py-8 md:py-12 border-t border-gray-200">

          {/* 1st block */}
          <div className="sm:col-span-12  lg:col-span-3">
            <div className="sm:mb-2 mb-0 sm:block flex justify-center align-center">
              <Logo />
            </div>
          ...
          {/* 5th block */}
          <div className="sm:col-span-6 md:col-span-3 lg:col-span-3 hidden sm:block">
            <h6 className="text-gray-800 font-medium mb-2">Subscribe</h6>
            <p className="text-sm text-gray-600 mb-4">Abonati-va la newsletter-ul nostru si nu pierdeti ultimele stiri si tendinte din mediul de afaceri.</p>
            <form>
                ...
                <div className="w-full">
                  ...
                  <div className="relative flex items-center max-w-xs">
                    ...
                    <button type="submit" className="absolute inset-0 left-auto" aria-label="Subscribe">
                      ...
                      <svg className="w-3 h-3 fill-current text-orange-600 mx-3 shrink-0" viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="md:flex md:items-center  md:justify-between py-4 md:py-8 border-t border-gray-200">
          ...
          <ul className="flex mb-4 md:order-1 md:ml-4 md:mb-0">
            ...
            <li className="ml-4 hidden sm:block">
              <a href="https://www.facebook.com/groups/393180652477597" target='_blank' className="flex justify-center items-center text-gray-600 hover:text-gray-900 bg-white hover:bg-white-100 rounded-full shadow transition duration-150 ease-in-out" aria-label="Facebook">
                <svg className="w-8 h-8 fill-current" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
          ...
          {/* Copyrights note */}
          <div className="text-sm text-gray-600 mr-4">&copy; Cabinet Consultanta Lelica Crisan. All rights reserved.</div>
