          ...
          <div className="flex flex-col items-center pt-12 md:pt-16">
            <div className="relative">
              ...
              <svg className="absolute top-0 w-full h-auto" viewBox="0 0 400 400" style={{ left: '12%' }} xmlns="http://www.w3.org/2000/svg">
                <defs>
                  ...
                  <linearGradient x1="50%" y1="0%" x2="50%" y2="100%" id="world-ill-f">
                    <stop stopColor="#FA842A" stopOpacity="0" offset="0%" />
                    <stop stopColor="#FA842A" stopOpacity=".64" offset="52.449%" />
                    <stop stopColor="#FA842A" stopOpacity="0" offset="100%" />
                  </linearGradient>
                </defs>
                <g transform="translate(0 -.818)" fill="none" fillRule="evenodd">
                  <use fill="#000" filter="url(#world-ill-a)" xlinkHref="#world-ill-b" />
                  <use fill="#FA842A" xlinkHref="#world-ill-b" />
                  <use fill="#000" filter="url(#world-ill-c)" xlinkHref="#world-ill-d" />
                  <use fill="#FA842A" xlinkHref="#world-ill-d" />
                  <ellipse fillOpacity=".32" fill="#FA842A" cx="293" cy="142.303" rx="8" ry="7.788" />
                  <ellipse fillOpacity=".64" fill="#FA842A" cx="250" cy="187.083" rx="6" ry="5.841" />
                  <ellipse fillOpacity=".64" fill="#FA842A" cx="13" cy="233.811" rx="2" ry="1.947" />
                  <ellipse fill="#FA842A" cx="29" cy="114.072" rx="2" ry="1.947" />
              ...
              <svg className="absolute max-w-full" width="48" height="48" viewBox="0 0 48 48" style={{ width: '12%', top: '45%', left: '50%' }} xmlns="http://www.w3.org/2000/svg">
                <g className="fill-current text-orange-600">
